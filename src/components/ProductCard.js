  ...
  return (
    <div className="product-card">
      <div style={{ position: 'relative', width: '100%', aspectRatio: '1', borderRadius: '12px 12px 0 0', overflow: 'hidden' }}>
        ...
        {!product.available && (
          <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', color: 'var(--text-secondary)', fontSize: '0.875rem' }}>Sold Out</div>
        )}
      </div>
      <div className="product-card-body">
        ...
        <div className="product-card-footer">
          ...
          {quantity > 0 ? (
            ...
            <button onClick={handleIncrement} className="add-to-cart-btn" aria-label="Add to cart" disabled={!product.available} style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '2.25rem', height: '2.25rem', borderRadius: '50%' }}>
